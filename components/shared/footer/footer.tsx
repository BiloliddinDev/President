        ...
        <footer className={"container"}>
            <div className={"flex justify-between mt-[100px] mb-4 items-start pb-11 border-b-[1px] border-gray-200"}>
                ...
                <ul className={"flex flex-col items-start"}>
                    <h2 className={"text-gray-500 text-sm  font-medium leading-normal mb-[40px]"}>SUPPORT</h2>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>Customer Service</li>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>Returns & Refunds</li>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>Delivery</li>
                </ul>
                <ul className={"flex flex-col items-start"}>
                    <h2 className={"text-gray-500 text-sm font-medium leading-normal mb-[40px]"}>COMPANY</h2>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>Sustainability</li>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>Corporate Gifts</li>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>President B2B</li>
                </ul>
                <ul className={"flex flex-col items-start"}>
                    <h2 className={"text-gray-500 text-sm font-medium leading-normal mb-[40px]"}>SHOP</h2>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>Gifts</li>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>News</li>
                    <li className={"text-gray-600 text-sm mb-4 font-medium leading-normal"}>Follow your Order</li>
                </ul>
                <ul className={"flex flex-col items-start"}>
                    <h2 className={"text-gray-500 text-sm font-medium leading-normal mb-[40px]"}>ACCEPTED PAYMENTS</h2>
            ...
            <p className={"text-gray-600 text-sm font-normal leading-normal text-center pb-6"}>© 2025 President Business
                Gifts. All rights reserved.</p>
        </footer>
    )
};
