    ...
    <div>
      ...
      <div className="container ">
        <div className="w-[590px] flex flex-col justify-start items-start gap-7">
          <div className="self-stretch justify-start text-primary text-lg font-medium  leading-7">
            {/* Returns & Refunds */}Возврат и возмещение
          </div>
          <div className="self-stretch flex flex-col justify-start items-start gap-3.5">
            <div className="self-stretch justify-start text-zinc-700 text-base font-medium  leading-normal mb-4">
        ...
        <div className="self-stretch justify-start">
          <span className="text-gray-900 text-sm font-medium leading-tight">
            Вы можете вернуть любой товар, приобретенный в интернет-магазине
            Montblanc, в течение 30 дней с момента доставки. Вот как:
            <br />
          </span>
          ...
          <span className="text-gray-900 text-sm font-medium leading-tight">
            ...
            <br />
            Убедитесь, что товар находится в оригинальном состоянии, включая
            бирки и упаковку. В противном случае возврат не принимается, и
          ...
          <span className="text-gray-900 text-sm font-medium leading-tight">
             прилагаемой к посылке. Если документы неполные, посылка не будет
            принята и будет возвращена вам.
            <br />
            Отправьте посылку с помощью любой удобной курьерской службы за свой
            счёт на наш склад в Италии.
            <br />
            ⚠️ Индивидуально персонализированные товары (с именем или уникальным
            дизайном) не подлежат возврату или обмену.
            <br />
            После того как посылка поступит на склад, пожалуйста, дайте от 3 до
            7 рабочих дней (в зависимости от загруженности) на обработку
            возврата. Если ваш возврат не соответствует указанным условиям,
            посылка будет отправлена обратно. После подтверждения возврата
            оплата будет возмещена, и вы получите уведомление по электронной
            почте.
            <br />
            Обратите внимание, что парфюмерия возврату не подлежит.
            <br />
            Для получения дополнительной информации об условиях возврата,
