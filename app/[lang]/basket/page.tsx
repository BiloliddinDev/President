    ...
    return (
        <div>
            <div className={"container md:!mt-26 !mt-42"}>
                <BreadcrumbDynamic/>
                <h2 className="text-primary text-4xl font-medium leading-10 my-5">{dictionary.basket.shoppingCart}</h2>
            </div>
            <div className={"container md:!mt-20  !mt-10 flex md:flex-row flex-col-reverse justify-between  gap-10 "}>
                <BasketLeftSection dictionary={dictionary}/>
                <BasketRightSection dictionary={dictionary}/>
            </div>
        </div>
    );
}
