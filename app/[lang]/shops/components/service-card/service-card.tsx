...
export const ServiceCard = ({text, iconName, link}: { text: string, iconName: string, link: string }) => {
    return (
        <Link href={`service/${link}`}>
            <div data-property-1="Default"
                ...
                <div
                    className="w-32 justify-start text-primary text-sm font-medium font-['Inter'] leading-tight">
                    {text}
                </div>
