...
export async function generateMetadata({
  ...
  const product: ProductsInterface = (await ProductDetailService(
    Number(DetailPageParam.detail)
...
export default async function Page({ params }: DetailPageProps) {
  ...
  return <ProductDetailPage product={product} dictionary={dictionary} category={DetailPageParam.category}/>;
}
