    ...
    return (
        <div className="container max-w-screen-xl mx-auto px-2 md:px-4  md:!mt-26 !mt-42">
            ...
            <WatchVsText
                ...
                textInfo={'Высокие технологии — в каждой детали\n' +
                    'Мы применяем современные технологии обработки, тестирования и брендирования, чтобы каждая вещь была не просто красивой, но и долговечной. Благодаря точной инженерии, интеграции новых решений и дизайнерской экспертизе — вы получаете продукт, в котором сочетаются традиции, стиль и технологичность.'}
                videoSrc={"/videos/vid5.mp4"}
            />
            <CommonWatchSection
                productType="Инновации"
                description="Механизм, представленный миру"
                textInfo="Благодаря точной инженерии, интеграции новых решений и дизайнерской экспертизе — вы получаете продукт, в котором сочетаются традиции, стиль и технологичность."
