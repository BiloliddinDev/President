...
Мы самостоятельно разрабатываем дизайн, подбираем материалы премиального уровня и контролируем каждый этап производства."
      ...
      <CommonWatchSection
        ...
        textInfo="Мы применяем современные технологии обработки, тестирования и брендирования, чтобы каждая вещь была не просто красивой, но и долговечной. Благодаря точной инженерии, интеграции новых решений и дизайнерской экспертизе — вы получаете продукт, в котором сочетаются традиции, стиль и технологичность. Благодаря точной инженерии, интеграции новых решений и дизайнерской экспертизе — вы получаете продукт, в котором сочетаются традиции, стиль и технологичность."
